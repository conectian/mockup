...
export default function DealRoomPage() {
                ...
                return (
                    <div className="p-8 max-w-4xl mx-auto space-y-6">
                        <div className="space-y-1">
                            <h2 className="text-3xl font-display font-bold tracking-tight">Ficha Técnica</h2>
            ...
            case 'participants':
                return (
                    <div className="p-8 max-w-5xl mx-auto space-y-8">
                        <div className="space-y-1">
                            <h2 className="text-3xl font-display font-bold tracking-tight">Participantes</h2>
                            <p className="text-muted-foreground text-lg">Equipo multidisciplinar involucrado en la negociación.</p>
                        </div>
                            ...
                            {participants.map((p) => (
                                <div key={p.id} className="flex items-center gap-4 p-5 glass-card border-white/5 rounded-[2rem] hover:border-primary/20 transition-all group">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs font-bold uppercase tracking-wider text-muted-foreground/60">{p.role}</div>
                                    </div>
                                </div>
                            ))}
                        </div>
    ...
    return (
        <div className="fixed inset-0 flex bg-background/95 backdrop-blur-3xl">
            {/* Left Menu - Glassmorphism */}
            <aside
                className={cn(
                    'bg-card/40 backdrop-blur-xl border-r border-white/5 flex flex-col transition-all duration-500 shrink-0 z-40',
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                {/* Sub-header for views that need it (optional) */}
