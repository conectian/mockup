...
export default function AppHeader() {
    ...
    return (
        <>
            <header className="h-14 md:h-16 border-b border-white/5 bg-background/95 backdrop-blur-xl sticky top-0 z-30 flex items-center justify-between px-3 md:px-4 lg:px-8">
