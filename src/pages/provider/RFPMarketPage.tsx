            ...
            <div className="space-y-6 min-w-0">
                ...
                <div className="flex flex-col gap-4">
                    <div className="min-w-0">
                        <h1 className="text-2xl md:text-3xl font-display font-bold tracking-tight truncate">Oportunidades de Negocio</h1>
                    ...
                    <div className="flex gap-2 w-full">
                        ...
                        <Button variant="outline" className="lg:hidden gap-2 border-white/10 hover:bg-white/5 shrink-0">
