                        ...
                        <div key={msg.id} className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                            {msg.type === 'system' ? (
                                <div className="flex justify-center my-4">
                                    <div className={cn(
                                        'flex items-center gap-3 px-6 py-2 rounded-2xl border backdrop-blur-sm text-xs font-bold tracking-tight shadow-lg shadow-black/5',
                                    ...
                                    <div
                                        className={cn(
                                            ...
                                            msg.senderRole === 'client'
                                                ? 'bg-gradient-to-br from-primary to-indigo-600 text-primary-foreground rounded-3xl rounded-tr-none shadow-primary/20'
                                                : 'bg-card/80 backdrop-blur-md border border-white/10 rounded-3xl rounded-tl-none shadow-black/5'
                                        )}
                                    >
            ...
            <div className="p-6 pb-8 border-t border-white/5 bg-background/80 backdrop-blur-xl sticky bottom-0">
                <div className="max-w-4xl mx-auto space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2 px-1">
                        <Button variant="outline" size="sm" className="h-9 gap-2 text-xs font-bold rounded-xl bg-white/5 border-white/10 hover:border-primary/50 hover:bg-white/10 transition-all">
                    ...
                    <div className="relative group">
                        <div className="absolute inset-0 bg-gradient-to-r from-primary/20 via-indigo-600/20 to-primary/20 rounded-[2rem] blur-xl opacity-0 group-focus-within:opacity-100 transition-opacity duration-500" />
                        <div className="relative flex items-center gap-3 p-2 bg-card border border-white/10 rounded-[1.8rem] shadow-2xl focus-within:border-primary/40 transition-all">
                            ...
                            <Button
                                ...
                                className="h-12 w-12 shrink-0 rounded-2xl bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95 disabled:opacity-20 disabled:scale-100"
                            >
